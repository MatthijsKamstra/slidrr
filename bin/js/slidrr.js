...
var Main = function() {
	...
	this._currentId = 0;
	var _gthis = this;
	if(window.document.getElementById("slidrr-speakrr-notes") != null) {
		window.console.debug("** Test speakrr notes ** ");
		this.isSpeakrrNotes = true;
	}
	if(window.document.getElementById("slidrr-speakrr-notes-gen") != null) {
	...
	haxe_Log.trace("slidrrConfig: " + Std.string($global.slidrrConfig),{ fileName : "Main.hx", lineNumber : 59, className : "Main", methodName : "new"});
};
Main.__name__ = true;
Main.main = function() {
	var app = new Main();
...
Main.prototype = {
	init: function() {
		...
		var arr = HxOverrides.substr(window.location.search,1,null).split("&");
		var _g1 = 0;
		var _g = arr.length;
		while(_g1 < _g) {
			var i = _g1++;
	...
	,buildPresentation: function(md) {
		var _gthis = this;
		var flexContainer = window.document.createElement("div");
		flexContainer.className = "slidrr-container";
		window.document.body.appendChild(flexContainer);
		...
		this.buildNav();
		var _nav = window.document.getElementsByClassName("nav")[0];
	...
	,buildProgress: function() {
		...
		var _progressbar = window.document.createElement("div");
	...
	,buildControle: function() {
		...
		var _arrowL = window.document.createElement("div");
		_arrowL.className = "arrow left prev";
		_arrowL.innerHTML = "";
		var _arrowR = window.document.createElement("div");
	...
	,move: function(dir) {
		...
		if(this.shouldUpdateNotes && this.notesPopup != null) {
			this.notesPopup.postMessage("slide:" + this._currentId,"*");
		}
	...
	,toggleVisibleSlide: function(id,isVisible) {
		var slide = window.document.getElementById("slidrr-" + id);
	...
	,updateProgress: function() {
		...
		var progress = window.document.getElementsByClassName("progress-bar")[0];
	...
	,toggleFullscreen: function() {
		if(!this.isFullScreen) {
			...
			this.isFullScreen = false;
			if(($_=window.document,$bind($_,$_.exitFullscreen))) {
	...
	,toggleHelp: function() {
		...
		var help = window.document.getElementsByClassName("help")[0];
	...
	,toggleNav: function() {
		var help = window.document.getElementsByClassName("nav")[0];
		if(help.style.visibility == "visible") {
			help.style.visibility = "hidden";
			help.style.opacity = "0";
		} else {
	...
	,toggleFocus: function() {
		var focus = window.document.getElementsByClassName("focus")[0];
	...
	,showSpeakerNotes: function() {
		haxe_Log.trace("showSpeakerNotes",{ fileName : "Main.hx", lineNumber : 420, className : "Main", methodName : "showSpeakerNotes"});
		...
		this.notesPopup = window.open("","Notes::","width=1100,height=700");
		this.notesPopup.document.write(html);
		window.addEventListener("message",function(event) {
			haxe_Log.trace("received response: ",{ fileName : "Main.hx", lineNumber : 490, className : "Main", methodName : "showSpeakerNotes", customParams : [event.data]});
		},false);
	}
	...
	,onClickHandler: function(e) {
		...
		if(temp.className.indexOf("left") != -1) {
			haxe_Log.trace("left",{ fileName : "Main.hx", lineNumber : 526, className : "Main", methodName : "onClickHandler"});
			this.move(-1);
		} else {
			haxe_Log.trace("right",{ fileName : "Main.hx", lineNumber : 529, className : "Main", methodName : "onClickHandler"});
			this.move(1);
		}
	}
...
var view_SpeakrrNotesView = function(md) {
	...
	this._win.onmessage = function(event) {
		...
		var _u = _gthis._doc.URL.split("#");
		_gthis._doc.location.href = _u[0] + "#/" + curId;
		_gthis.buildNotes(md);
	};
};
...
view_SpeakrrNotesView.prototype = {
	clearNodes: function() {
		if(this.slideCurrentContainer == null || this.slideNextContainer == null) {
			return;
		}
